...
{
	AddGOComponent(new CS230::Sprite("assets/prince/rifleman.spt", this));
	ChangeState(&stateWalking);
}


bool Rifleman::CanCollideWith(GameObjectType objectBType)
{
	switch (objectBType)
	{
...
void Rifleman::State_Walking::TestForExit(GameObject* object)
{
	...
	for(GameObject* obj : Engine::GetGSComponent<CS230::GameObjectManager>()->Objects())
	{
		...
		case GameObjectType::Horde:
			...
			{
				rifleman->AttackWho = dynamic_cast<Level3Object*>(obj);
