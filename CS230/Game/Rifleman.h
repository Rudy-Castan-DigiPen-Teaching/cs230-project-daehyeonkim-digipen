...
class Rifleman final : public Level3Object
{
private:
	...
	double attackSpeed;
public:
	Rifleman(int identityCode, math::vec2 position, int hp, int ad, math::vec2 HPBarScale, math::vec2 movementSpeed, double attackSpeed);
